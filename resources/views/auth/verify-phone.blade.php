            ...
            <div id="phone-form" class=" hidden">
                <form method="POST" action="{{ route('phone.update.number') }}">
                    ...
                    <div class="mt-4">
                        ...
                        <x-input id="phone" class="block mt-1 w-full" type="tel" name="phone" :value="old('phone_full')"
                            autocomplete="off" />
                    </div>
                    <div>
            ...
            @if ($code == 201)
                <form method="POST" action="{{ route('phone.verify.otp') }}" id="verification-form">
                    ...
                    <div class="mt-4">
                        ...
                        <x-input id="otp" class="block mt-1 w-full" type="text" name="otp" autocomplete="off" />
                    </div>
                    <div>
