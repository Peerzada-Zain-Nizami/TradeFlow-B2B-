    ...
    <div class="bg-white rounded-lg w-1/2 sm:w-3/4">
      <div class="flex flex-col items-start p-4">
        <div class="flex items-center w-full border-b-1">
          <div class="text-gray-900 font-medium text-lg" id="modal-title"><?php echo e(__('Edit User Role')); ?></div>
            ...
            <form id="edit_user_role_form" method="POST" class="w-full">
                ...
                <div class='flex flex-shrink -mx-3 mb-6'>
                    <div class='w-full md:w-full px-3 mb-6'>
                        <label class='block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2' for='grid-text-1'><?php echo e(__('Select Role')); ?></label>
...
<?php /**PATH D:\Xampp\htdocs\AlahdeenB2b-main\AlahdeenB2b-main\resources\views/components/users/edit-role-modal.blade.php ENDPATH**/ ?>