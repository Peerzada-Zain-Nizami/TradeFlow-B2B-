<div class="flex items-center justify-center fixed left-0 bottom-0 w-full h-full bg-gray-800 bg-opacity-75 z-10 hidden modal" id="delete-modal">
  <div class="bg-white rounded-lg w-1/2">
    <div class="flex flex-col items-start p-4">
      ...
      <hr>
      <div class="confirmation_msg_div"><?php echo e(__('Are you sure you want to delete?')); ?></div>
      <hr>
      <div class="ml-auto">
        <form method="post">
            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\Xampp\htdocs\AlahdeenB2b-main\AlahdeenB2b-main\resources\views/components/delete-modal.blade.php ENDPATH**/ ?>