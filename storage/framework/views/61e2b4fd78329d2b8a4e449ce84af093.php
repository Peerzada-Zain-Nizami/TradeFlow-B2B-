    ...
    <div class="bg-white rounded-lg w-1/2 sm:w-3/4" style="height: 600px; overflow-y:scroll;">
      <div class="flex flex-col items-start p-4">
        <div class="flex items-center w-full border-b-1">
          <div class="text-gray-900 font-medium text-lg" id="modal-title"><?php echo e(__('Update Subscription Payment Status')); ?></div>
        ...
        <div class="w-full mt-6">
            <form id="subscription_payment_form" action="<?php echo e(route('admin.subscriptions.payment_status.update')); ?>" enctype="multipart/form-data" method="POST" class="w-full">
                <?php echo csrf_field(); ?>
                ...
                <div class='-mx-3 mb-6'>
                            ...
                            <section class="overflow-auto p-8 w-full h-full flex flex-col">
                              <header class="border-dashed border-2 border-gray-400 py-12 flex flex-col justify-center items-center">
                                ...
                                <button type="button" id="button" class="mt-2 rounded-sm px-3 py-1 bg-gray-200 hover:bg-gray-300 focus:shadow-outline focus:outline-none">
                                  <?php echo e(__('Upload a file')); ?>

                                </button>
                              </header>

                              <h1 class="pt-8 pb-3 font-semibold sm:text-lg text-gray-900">
                                <?php echo e(__('To Upload')); ?>
                              ...
                              <ul id="gallery" class="flex flex-1 flex-wrap -m-1">
                                <li id="empty" class="h-full w-full text-center flex flex-col items-center justify-center items-center">
                                  ...
                                  <span class="text-small text-gray-500"><?php echo e(__('No files selected')); ?></span>
                                </li>
                              </ul>
                            </section>
                    ...
                    <div class='w-full md:w-full px-3 my-6'>
                        <label class='block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2' for='grid-text-1'><?php echo e(__('Description')); ?></label>
                    ...
                    <div class='w-full md:w-full px-3 mb-6'>
                        <label class='block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2' for='grid-text-1'><?php echo e(__('Select Payment Status')); ?></label>
                        <select class="block appearance-none text-gray-600 w-full bg-white border border-gray-400 shadow-inner px-4 py-2 pr-8 rounded" name="status" id="status">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $subscription_statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($status); ?>"><?php echo e($status); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </select>
                    </div>
                    <div class='w-full md:w-full px-3 mb-6 hidden' id='amount_div'>
                        <label class='block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2' for='amount'><?php echo e(__('Paid Amount')); ?></label>
                    ...
                    <div class='w-full md:w-full px-3 mb-6 hidden' id='cancelled_div'>
                        <label class='uppercase tracking-wide text-gray-700 text-xs font-bold mb-2' for='closed'><?php echo e(__('Cancelled and closed')); ?></label>
...
<?php /**PATH D:\Xampp\htdocs\AlahdeenB2b-main\AlahdeenB2b-main\resources\views/components/subscription/admin/index/edit-status-modal.blade.php ENDPATH**/ ?>